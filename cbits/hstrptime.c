...
static double our_strtod(const char *s, char **sret);
static double our_wcstod(const wchar_t *s, wchar_t **sret);
...
// Copied from ReactOS, http://reactos-mirror.googlecode.com/svn/trunk/reactos/lib/sdk/crt/string/strtod.c
// and http://reactos-mirror.googlecode.com/svn/trunk/reactos/lib/sdk/crt/string/wcstod.c
// Modified to also handle ',' as decimal separator
